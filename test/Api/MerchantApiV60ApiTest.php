...
use OpenAPI\Client\Api\MerchantApiV60Api;
...
/**
 * MerchantApiV60ApiTest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class MerchantApiV60ApiTest extends TestCase
{
    public MerchantApiV60Api $api;
    ...
    public function setUp(): void
    {
        ...
        $this->api = new MerchantApiV60Api(null, $config);
    }
    ...
    {
        $body = new \OpenAPI\Client\Model\RequestCheckMultipleBodySchemaV60();
        $body->setPin($pin);
        $body->setCodes($codes);
    ...
    {
        $body = new \OpenAPI\Client\Model\RequestReservedBodySchemaV60();
        $body->setPin($pin);
        $body->setCodes($codes);
        $body->setBillNumber($billNumber);
    ...
    {
        $body = new \OpenAPI\Client\Model\RequestUnReservedBodySchemaV60();
        $body->setPin($pin);
        $body->setCodes($codes);
        $body->setBillNumber($billNumber);
    ...
    {
        $skuInfo = new \OpenAPI\Client\Model\RequestCheckMultipleBodySchemaV60SkusInfoInner();
