...
/**
 * ResponseCheckMultipleSchemaV60 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResponseCheckMultipleSchemaV60 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseCheckMultipleSchemaV60';
    ...
    protected static $openAPITypes = [
        ...
        'messageEn' => 'string',
        'messageVi' => 'string',
        'data' => '\OpenAPI\Client\Model\ResponseCheckMultipleSchemaV60DataInner[]'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \OpenAPI\Client\Model\ResponseCheckMultipleSchemaV60DataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \OpenAPI\Client\Model\ResponseCheckMultipleSchemaV60DataInner[]|null $data Detail items of voucher, if result is failed, response will return the first voucher code which is invalid
     *
     * @return self
     */
