...
**data** | [**\OpenAPI\Client\Model\ResponseCheckMultipleSchemaDataInner[]**](ResponseCheckMultipleSchemaDataInner.md) | Detail items of voucher, if result is failed, response will return the first voucher code which is invalid | [optional]
